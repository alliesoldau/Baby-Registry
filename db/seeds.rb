...
b2 = BabyShower.create(baby_shower_name: "Freddie's baby shower", date: "2024-01-16", address: "Freddie's fish tank", image_url: "https://www.customaquariums.com/wp-content/uploads/2019/02/100-gallon-aquarium-24_-x-48_-x-18_-colonial-oak-stain-classic-trim-standard-flat-panels-showcase-image.jpg", description: "Freddie and Freddie are having babies!!", user_id: u2.id)
